...
export default async function BlogPage() {
  ...
  return (
    <section>
      ...
      <BlurFade delay={BLUR_FADE_DELAY}>
        <h3 className="font-medium text-sm mb-8 tracking-tighter">Exploring tech, life, and everything in between. Join me as I share my perspectives on various topics. I hope you find something intriguing!</h3>
      </BlurFade>
      {posts
        .sort((a, b) => {
          if (
