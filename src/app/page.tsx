    ...
    <main className="flex flex-col min-h-[100dvh] space-y-10">
      ...
      <section id="about">
        ...
        <BlurFade delay={BLUR_FADE_DELAY * 4}>
          <Markdown className="prose max-w-full text-pretty font-sans text-paragraph text-muted-foreground dark:prose-invert md:text-xl/relaxed lg:text-paragraph/relaxed xl:text-xl/relaxed">
            {DATA.summary}
          </Markdown>
        </BlurFade>
      </section>
